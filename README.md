  ...
  - PanelType: "SSPanel" # Panel type: SSPanel
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertDomain:  # Optional. Leave empty to use panel node SNI as certificate domain for non-REALITY TLS nodes. Manual input format:"node1.test.com"
        CertFile:  # Only used when CertMode = file. Leave empty to use default path /etc/XrayR/cert/<SNI>.cert
        KeyFile:  # Only used when CertMode = file. Leave empty to use default path /etc/XrayR/cert/<SNI>.key
    ...
    #      CertConfig:
    #        CertMode: dns # Option about how to get certificate: none, file, http, tls, dns. Choose "none" will forcedly disable the tls config.
    #        CertDomain:  # Optional. Leave empty to use panel node SNI as certificate domain for non-REALITY TLS nodes.
    #        CertFile:  # Only used when CertMode = file. Leave empty to use default path /etc/XrayR/cert/<SNI>.cert
    #        KeyFile:  # Only used when CertMode = file. Leave empty to use default path /etc/XrayR/cert/<SNI>.key
    #        Provider: alidns # DNS cert provider, Get the full support list here: https://go-acme.github.io/lego/dns/
    #        Email: test@me.com
